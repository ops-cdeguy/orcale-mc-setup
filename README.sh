...
> **Note for Oracle Cloud Users:** Make sure to also add an **Ingress Rule** for Port `25565` (TCP/UDP) in your Oracle Cloud Console under *Networking -> Virtual Cloud Networks -> Default Security List -> Ingress Rules*.
